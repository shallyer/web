...
exports.default = new _vuex2.default.Store({
  ...
  mutations: {
    setCurrentTabName: function setCurrentTabName(state, _tabName) {
      state.currentTabName = _tabName;
    },
    setSchemeTempObject: function setSchemeTempObject(state, _schemeTempObject) {
      state.schemeTempObject = _schemeTempObject;
    },
    clearSchemeTempObject: function clearSchemeTempObject(state) {
      state.schemeTempObject = null;
    },
    setNeedCurrentPages: function setNeedCurrentPages(state, _currentPages) {
    ...
    setNeedReturnThisPage: function setNeedReturnThisPage(state, _pagesObj) {
